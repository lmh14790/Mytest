 ...
 * 通过属性动画来实现平滑滚动
 */
public class MyScoller2 extends ViewGroup{
     ...
     */
    private int mode;
    public MyScoller2(Context context) {
        super(context);
        initView(context);
    }

    public MyScoller2(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public MyScoller2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void startMove2(int mode,int dx,int duration){
        ...
        animator.setIntValues(mCourrentPosition,mTargetPosition);
